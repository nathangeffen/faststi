...
import os
import sys
sys.path.insert(0, os.path.abspath('../../hawkmoth/hawkmoth'))
...
man_pages = [
    (master_doc, 'faststi', 'FastSTI Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FastSTI', 'FastSTI Documentation',
     author, 'FastSTI', 'One line description of project.',
     'Miscellaneous'),
]
